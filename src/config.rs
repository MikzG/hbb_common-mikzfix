...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("MikzFix Remote".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remote.mikzfix.tech"];
pub const RS_PUB_KEY: &str = "tCdS9vjuW6Tpt3mpoXtQOgXXID3lDewA6pKmmYWpOzE=";
